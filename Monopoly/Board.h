...
private:
	...
	int currRollAmount;		// keep the amount of steps that a user has accumulated
...
public:
	...
	void putsPlayerOnSpace(int index, int playerID, sf::RenderWindow& window, int dealChoice);
